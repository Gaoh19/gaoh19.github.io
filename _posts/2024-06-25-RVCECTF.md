...
Well, writing a script to find the common sizes in the zip file, 
...
Next, we find the the files that are not of size 21.
...
def function(zipPath):
    with zipfile.ZipFile(zipPath, 'r') as zipRef:
        files_not_sized_21 = [
            fileInfo.filename for fileInfo in zipRef.infolist()
            if fileInfo.file_size != 21 and not fileInfo.is_dir()
        ]
        
    return files_not_sized_21

zipPath = '/mnt/c/Documents3/CyberSec/Tempo/RVCTF/Miscellaneous/Ocean.zip'

print(*function(zipPath), sep='\n')
```

**Output:**

```python
abu@Abdur-PC:/mnt/c/Documents3/CyberSec/Tempo/RVCTF/Miscellaneous$ python3 script.py
Ocean/chall169/file69
Ocean/chall213/file158
Ocean/chall300/file104
Ocean/chall348/file106
Ocean/chall405/file39
Ocean/chall405/file52
Ocean/chall439/file449
Ocean/chall461/file108
```
